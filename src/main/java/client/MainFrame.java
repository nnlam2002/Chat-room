...
//		panel_1.setBackground(Color.BLACK);
		panel_1.setBounds(453, 10, 187, 98);
		...
		lblNewLabel_2.setBounds(10, 24, 85, 24);
		panel_1.add(lblNewLabel_2);

		JLabel lblNewLabel_3 = new JLabel("Port Server:");
		lblNewLabel_3.setFont(new Font("Tahoma", Font.PLAIN, 14));
		lblNewLabel_3.setForeground(Color.BLACK);
		lblNewLabel_3.setBounds(10, 64, 85, 13);
...
//		panel_1.add(lblNewLabel_7);
	...
	private void connectChat() {
		...
		int n = JOptionPane.showConfirmDialog(this, "Do you want to connect with this user?", "Connect",
